...
if (!process.env.TEST_SITE_URL) {
  process.env.TEST_SITE_URL = "http://test-amon-carter-web.pantheonsite.io/";
  console.error("ERROR: using local fallback.");
}
if (!process.env.MULTIDEV_SITE_URL) {
  process.env.MULTIDEV_SITE_URL = "http://dev-amon-carter-web.pantheonsite.io/";
  console.error("ERROR: using local fallback.");
}
if (!process.env.TERMINUS_SITE) {
  process.env.TERMINUS_SITE = "amon-carter-web";
  console.error("ERROR: using local fallback.");
}
